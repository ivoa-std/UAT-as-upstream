...
that it issomewhat flatter than 
...
use of UAT relationships in VO discovery. If a data provider didn't evaluate
the full list of available UAT concepts and used "nebulae" to tag their
supernova remnats, and a user search for just nebula would miss the
...
And if there are too many results, then narrowing the query to "supernova remnant"
